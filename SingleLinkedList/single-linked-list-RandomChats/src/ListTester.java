...
public class ListTester {
	...
	private void runTests() {
		...
		testTwoElementList(AB_setB_AC, "AB_setB_AC", LIST_AC, STRING_AC);
...
//			break;
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_setB_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.set(1, ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_setB_AC = () -> AB_setB_AC();
	...
	/** Scenario: [A,B,C] -> set(B) -> [A,A,C] 
	 * @return [] after set(B)ABC_setBToA_AAC
	 */
