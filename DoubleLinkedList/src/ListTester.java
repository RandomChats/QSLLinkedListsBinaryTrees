...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_addD_D, "emptyList_addD_D", LIST_D, STRING_D);
		...
		testEmptyList(A_remove_emptyList, "A_remove_emptyList");
		testEmptyList(A_removeX_emptyList, "A_remove_emptyList");
		...
		testTwoElementList(A_add0B_BA, "A_addB_BA", LIST_BA, STRING_BA);
		...
		testSingleElementList(A_setA_A, "A_setA_A", LIST_A, STRING_A);
		...
		testThreeElementList(AB_iterAddCAfterA_ACB, "AB_iterAddCAfterA_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_iterAddCAfterB_ABC, "AB_iterAddCAfterB_ABC", LIST_ABC, STRING_ABC);
...
//			break;
	...
	/** Scenario: [A] -> remove(element) -> [] 
	 * @return [] after remove(element)
	 */
	private IndexedUnsortedList<Integer> A_remove_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.remove(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> A_remove_emptyList = () -> A_remove_emptyList();
	
	/** Scenario: [A] -> remove(int) -> [] 
	 * @return [] after remove(int)
	 */
	private IndexedUnsortedList<Integer> A_removeX_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.remove(0);
		return list;
	}
	private Scenario<Integer> A_removeX_emptyList = () -> A_removeX_emptyList();
	
	
	
	//SINGLE ELEMENT LIST TESTS
	
	/** Scenario: empty list -> addToRead(A) -> [A] 
	 ...
	 * @return [] after set(A)
	 */
	private IndexedUnsortedList<Integer> A_setA_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.set(0, ELEMENT_A);
		return list;
	}
	private Scenario<Integer> A_setA_A = () -> A_setA_A();
	...
	/** Scenario: empty list -> add(D) -> [D] 
	 * @return [D] after add(D)
	 */
	private IndexedUnsortedList<Integer> emptyList_addD_D() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.add(ELEMENT_D);
		return list;
	}
	private Scenario<Integer> emptyList_addD_D = () -> emptyList_addD_D();
	...
	/** Scenario: [A] -> addAfter(A) -> [A,B] 
	 * @return [A,B] after addAfter(A)
	 */
	 ...
	 * @return [A,C] after remove(element)
	 */
	...
	/** Scenario: [A,B] -> set(B) -> [A,C] 
	 * @return [A,C] after set(B)
	 */
	...
	/** Scenario: [A,B,C] -> set(C,D) -> [A,B,D] 
	 * @return [A,B,C] after set(C,D) -> ABC_setCToD_ABD
	 */
	...
	/** Scenario: [A, B] -> addAfter(A,C) -> [A,C,B] 
	 * @return [A,C,B] after addAfter(A,C)
	 */
	...
	/** Scenario: [A, B] -> addAfter(B,C) -> [A,B,C] 
	 * @return [A,B,C] after addAfter(B,C)
	 */
	...
	/** Scenario: [A, B, C] -> iteratorRemoveAfterNextB -> [A, B] 
	 * @return [A, B] after iteratorRemove
	 */
	...
	/** Scenario: [A] -> listIteratorAddB -> [A,B] 
	 * @return [A,B] after listIteratorAddB
	 */
	...
	/** Scenario: [A,B] -> listIteratorAddAfterNextA -> [C,A,B] 
	 * @return [C,A,B] after listIteratorAdd
	 */
	...
	/** Scenario: [A,B] -> listIteratorAddAfterNextA -> [A,C,B] 
	 * @return [A,C,B] after listIteratorAdd
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterA_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterAddCAfterA_ACB = () -> AB_iterAddCAfterA_ACB();
	
	/** Scenario: [A,B] -> listIteratorAddAfterNextB -> [A,B,C] 
	 * @return [A,B,C] after listIteratorAdd
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterB_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_iterAddCAfterB_ABC = () -> AB_iterAddCAfterB_ABC();
